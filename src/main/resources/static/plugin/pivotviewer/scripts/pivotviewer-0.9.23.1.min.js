/* 
 ...
 Copyright © 2013 LobsterPot Solutions - www.lobsterpot.com.au. All rights reserved 
    ...
    init: function (e) {
        ...
        $.ajax({
            type: "GET", url: e, dataType: "xml", success: function (e) {
                ...
                var r = $(e).find("I");
                if (r.length === 0) { $.publish("/PivotViewer/ImageController/Collection/Loaded", null); return;}
                var i = $(r[0]).find("Size");
                if (i.length > 0) {
